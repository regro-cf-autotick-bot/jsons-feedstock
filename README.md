...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jsons-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12430&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jsons-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jsons` can be installed with:

```
conda install jsons
```

It is possible to list all of the versions of `jsons` available on your platform with:
